#!/usr/bin/env Rscript
# Script: 13_time_series_cv_period.R
...
open_png("fig_13_time_series_cv_period.png", width = 4000, height = 3200, pointsize = 16)
layout(matrix(seq_len(4), nrow = 4))
par(mar = c(3, 3, 0.5, 2.8))

plot_time_series_panel(cosmoz_df, cv_dates, "CosmOz", "RF", "rf_cv", "rf_cc", c("#4c78a8", "#72b7b2"), "a")
plot_time_series_panel(cosmoz_df, cv_dates, "CosmOz", "XGB", "xgb_cv", "xgb_cc", c("#f58518", "#e45756"), "b")
plot_time_series_panel(ozflux_df, cv_dates, "OzFlux", "RF", "rf_cv", "rf_cc", c("#4c78a8", "#72b7b2"), "c")
plot_time_series_panel(ozflux_df, cv_dates, "OzFlux", "XGB", "xgb_cv", "xgb_cc", c("#f58518", "#e45756"), "d")
